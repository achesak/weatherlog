...
class GraphDialog(Gtk.Dialog):
    ...
    def __init__(self, parent, title, data, last_dataset, config, graph_data):
        """Create the dialog."""
        ...
        temp_graph.set_title("Temperature - %s" % last_dataset)
        ...
        chil_graph.plot(data["date_ticks"], data["chil_data"], color=config["graph_color"],
                        linewidth=config["line_width"], linestyle=lines[config["line_style"]])
        chil_graph.set_title("Wind Chill - %s" % last_dataset)
        ...
        prec_graph.plot(data["date_ticks"], data["prec_data"], color=config["graph_color"],
                        linewidth=config["line_width"], linestyle=lines[config["line_style"]])
        prec_graph.set_title("Precipitation - %s" % last_dataset)
        ...
        pramt_graph.set_title("Precipitation (Amount) - %s" % last_dataset)
        ...
        prday_graph.set_title("Precipitation (Days) - %s" % last_dataset)
        ...
        wind_graph.plot(data["date_ticks"], data["wind_data"], color=config["graph_color"],
                        linewidth=config["line_width"], linestyle=lines[config["line_style"]])
        wind_graph.set_title("Wind Speed - %s" % last_dataset)
        ...
        humi_graph.plot(data["date_ticks"], data["humi_data"], color=config["graph_color"],
                        linewidth=config["line_width"], linestyle=lines[config["line_style"]])
        humi_graph.set_title("Humidity - %s" % last_dataset)
        ...
        airp_graph.plot(data["date_ticks"], data["airp_data"], color=config["graph_color"],
                        linewidth=config["line_width"], linestyle=lines[config["line_style"]])
        airp_graph.set_title("Air Pressure - %s" % last_dataset)
        ...
        airc_graph.set_title("Air Pressure (Change) - %s" % last_dataset)
        ...
        visi_graph.plot(data["date_ticks"], data["visi_data"], color=config["graph_color"],
                        linewidth=config["line_width"], linestyle=lines[config["line_style"]])
        visi_graph.set_title("Visibility - %s" % last_dataset)
        ...
        clou_graph.set_title("Cloud Cover - %s" % last_dataset)
        ...
        ctyp_graph.set_title("Cloud Type - %s" % last_dataset)
