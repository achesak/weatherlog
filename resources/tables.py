...
################################################################################
#
# WeatherLog: tables.py
# This module calculates and organizes data for the Tables feature.
#
################################################################################
...
def build_table(value, min_val, max_val, avg_val, med_val, unit, unit_space=True):
    """Builds a table row."""
