...
def clear_graphs(self):
    """Clears and resets the graphs."""

    # Clear the graphs.
    self.graph_temp_graph.cla()
    self.graph_chil_graph.cla()
    self.graph_prec_graph.cla()
    self.graph_pramt_graph.cla()
    self.graph_prday_graph.cla()
    self.graph_wind_graph.cla()
    self.graph_humi_graph.cla()
    self.graph_airp_graph.cla()
    self.graph_airc_graph.cla()
    self.graph_visi_graph.cla()
    self.graph_clou_graph.cla()
    self.graph_ctyp_graph.cla()
