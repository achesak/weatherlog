...
def info_builder(self):
    ...
    self.info_gen_box_lbl = Gtk.Label("Overview")
    ...
    self.info_gen_cate_col.set_min_width(400)
    ...
    self.info_temp_cate_col.set_min_width(400)
    ...
    self.info_chil_cate_col.set_min_width(400)
    ...
    self.info_prec_cate_col.set_min_width(400)
    ...
    self.info_wind_cate_col.set_min_width(400)
    ...
    self.info_humi_cate_col.set_min_width(400)
    ...
    self.info_airp_cate_col.set_min_width(400)
    ...
    self.info_visi_cate_col.set_min_width(400)
    ...
    self.info_clou_cate_col.set_min_width(400)
    ...
    self.info_note_cate_col.set_min_width(400)
